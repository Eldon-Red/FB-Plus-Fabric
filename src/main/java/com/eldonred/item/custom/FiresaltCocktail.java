package com.eldonred.item.custom;
...
public class FiresaltCocktail extends PotionItem {
    public FiresaltCocktail(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.literal("Has a kick.").formatted(Formatting.GOLD));
    }
